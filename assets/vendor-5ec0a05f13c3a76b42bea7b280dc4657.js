...
if(i)return i
var[n,a]=t.split(":")
return _[t]=(0,r.intern)(`${n}:${a}-${R}`)},e.setFactoryFor=v
var a=void 0
...
class g{constructor(e,t,i,n){this.container=e,this.owner=e.owner,this.class=t,this.fullName=i,this.normalizedName=n,this.madeToString=void 0,this.injections=void 0,v(this,this),l(e,i)&&(r.HAS_NATIVE_SYMBOL||m in t)&&v(t,this)}toString(){return void 0===this.madeToString&&(this.madeToString=this.container.registry.makeToString(this.class,this.fullName)),this.madeToString}create(e){var{container:t}=this
...
var _=(0,r.dictionary)(null),R=`${Math.random()}${Date.now()}`.replace(".","")})),e("@ember/-internals/environment/index",["exports","@ember/deprecated-features"],(function(e,t){"use strict"
...
function y(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}var _=y(r),R=y(u),w=y(d),O=y(v)
...
return E(r)?e()(...r):e(...r)}}var P=T((function(e,t){"object"==typeof e?(t=e,e=void 0):t=t||{}
...
return this.store._backburner.join((()=>{r.setDirtyHasMany(e,t)})),r.getHasMany(e)}}).meta(i)})),x=w.default.extend(i.DeprecatedEvented,{_registerHandlers(e,t){this._registeredHandlers={becameInvalid:e,becameValid:t}},errorsByAttributeName:r.computed((function(){return new Map})),errorsFor(e){var t=r.get(this,"errorsByAttributeName"),i=t.get(e)
...
e.forEach((function(e,r){t.push(r)})),e.clear(),t.forEach((e=>{this.notifyPropertyChange(e)})),w.default.prototype.clear.call(this)}},has(e){return this.errorsFor(e).length>0}})
...
return e.subscribe(),e.isDirty&&e.consume(i.call(this)),e.value},r.set=function(e){U(this,t),n.call(this,e)},a.dependentKeyCompat(r),r}var V,q,W,G,Y=(C=F((k=class{constructor(e){I(this,"isSaving",C,this)
...
var n,a,s,o,l=null
n=this.meta,(a=n.options)&&null===a.inverse||(l=t.inverseFor(this.key,e)),l?(r=l.name,i=void 0===(o=(s=l).options&&s.options.async)||o):(r=null,i=!1),this.__inverseKey=r,this.__inverseIsAsync=i}}function J(e,t,r,i,n){var a={}
return Object.keys(i).forEach((function(e){a[e]=i[e]})),a.enumerable=!!a.enumerable,a.configurable=!!a.configurable,("value"in a||a.initializer)&&(a.writable=!0),a=r.slice().reverse().reduce((function(r,i){return i(e,t,r)||r}),a),n&&void 0!==a.initializer&&(a.value=a.initializer?a.initializer.call(n):void 0,a.initializer=void 0),void 0===a.initializer&&(Object.defineProperty(e,t,a),a=null),a}var{changeProperties:X}=R.default,Z=a.dependentKeyCompat
...
return e||(e={hasComputed:!1,value:void 0},i.set(this,e)),e.hasComputed||(e.value=n.call(this),e.hasComputed=!0),e.value},r}var re=(G=W=class extends _.default{constructor(){var e,t,r,i
super(...arguments),e=this,t="isReloading",i=this,(r=q)&&Object.defineProperty(e,t,{enumerable:r.enumerable,configurable:r.configurable,writable:r.writable,value:r.initializer?r.initializer.call(i):void 0})}init(){super.init(...arguments),this.___recordState=new Y(this)}get isEmpty(){return this.currentState.isEmpty}get isLoading(){return this.currentState.isLoading}get isLoaded(){return this.currentState.isLoaded}get hasDirtyAttributes(){return this.currentState.isDirty}get isSaving(){return this.currentState.isSaving}get isDeleted(){return this.currentState.isDeleted}get isNew(){return this.currentState.isNew}get isValid(){return this.currentState.isValid}get dirtyType(){return this.currentState.dirtyType}get isError(){return this.currentState.isError}set isError(e){$(this,"isError").value=e}get id(){return this._internalModel.id}set id(e){var t=i.coerceId(e)
...
return this.eachAttribute(((t,r)=>{r.type&&e.set(t,r.type)})),e}static eachAttribute(e,t){this.attributes.forEach(((r,i)=>{e.call(t,i,r)}))}static eachTransformedAttribute(e,t){this.transformedAttributes.forEach(((r,i)=>{e.call(t,i,r)}))}static toString(){return`model:${r.get(this,"modelName")}`}},W.isModel=!0,W.modelName=null,J((V=G).prototype,"isEmpty",[a.dependentKeyCompat],Object.getOwnPropertyDescriptor(V.prototype,"isEmpty"),V.prototype),J(V.prototype,"isLoading",[a.dependentKeyCompat],Object.getOwnPropertyDescriptor(V.prototype,"isLoading"),V.prototype),J(V.prototype,"isLoaded",[a.dependentKeyCompat],Object.getOwnPropertyDescriptor(V.prototype,"isLoaded"),V.prototype),J(V.prototype,"hasDirtyAttributes",[a.dependentKeyCompat],Object.getOwnPropertyDescriptor(V.prototype,"hasDirtyAttributes"),V.prototype),J(V.prototype,"isSaving",[a.dependentKeyCompat],Object.getOwnPropertyDescriptor(V.prototype,"isSaving"),V.prototype),J(V.prototype,"isDeleted",[a.dependentKeyCompat],Object.getOwnPropertyDescriptor(V.prototype,"isDeleted"),V.prototype),J(V.prototype,"isNew",[a.dependentKeyCompat],Object.getOwnPropertyDescriptor(V.prototype,"isNew"),V.prototype),J(V.prototype,"isValid",[a.dependentKeyCompat],Object.getOwnPropertyDescriptor(V.prototype,"isValid"),V.prototype),J(V.prototype,"dirtyType",[a.dependentKeyCompat],Object.getOwnPropertyDescriptor(V.prototype,"dirtyType"),V.prototype),J(V.prototype,"isError",[Z],Object.getOwnPropertyDescriptor(V.prototype,"isError"),V.prototype),q=J(V.prototype,"isReloading",[l.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),J(V.prototype,"id",[H],Object.getOwnPropertyDescriptor(V.prototype,"id"),V.prototype),J(V.prototype,"currentState",[H],Object.getOwnPropertyDescriptor(V.prototype,"currentState"),V.prototype),J(V.prototype,"errors",[te],Object.getOwnPropertyDescriptor(V.prototype,"errors"),V.prototype),J(V.prototype,"adapterError",[Z],Object.getOwnPropertyDescriptor(V.prototype,"adapterError"),V.prototype),J(V,"inverseMap",[te],Object.getOwnPropertyDescriptor(V,"inverseMap"),V),J(V,"relationships",[te],Object.getOwnPropertyDescriptor(V,"relationships"),V),J(V,"relationshipNames",[te],Object.getOwnPropertyDescriptor(V,"relationshipNames"),V),J(V,"relatedTypes",[te],Object.getOwnPropertyDescriptor(V,"relatedTypes"),V),J(V,"relationshipsByName",[te],Object.getOwnPropertyDescriptor(V,"relationshipsByName"),V),J(V,"relationshipsObject",[te],Object.getOwnPropertyDescriptor(V,"relationshipsObject"),V),J(V,"fields",[te],Object.getOwnPropertyDescriptor(V,"fields"),V),J(V,"attributes",[te],Object.getOwnPropertyDescriptor(V,"attributes"),V),J(V,"transformedAttributes",[te],Object.getOwnPropertyDescriptor(V,"transformedAttributes"),V),V)
...
break}o=i-u-a,l=r-u-a}return{firstChangeIndex:a,addedCount:o,removedCount:l}}re.prototype._internalModel=null,re.prototype.store=null,re.prototype._debugInfo=function(){var e=["id"],t={},r=[]
...
function R(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}var w=R(i),O=R(u),E=R(d),T=R(h),P=R(p),A=R(m),S=R(g),M=R(b),k=R(y)
function C(e){return null==e||""===e?null:"string"==typeof e?e:"symbol"==typeof e?e.toString():""+e}function j(e){var t=null
if("string"==typeof e?t=e.length>0?e:null:"number"!=typeof e||isNaN(e)||(t=""+e),null===t)throw new Error(`Expected id to be a string or number, received ${String(e)}`)
return t}function x(e){return f.dasherize(e)}var D="undefined"!=typeof Symbol?Symbol:e=>`__${e}${Math.floor(Math.random()*Date.now())}__`
...
for(var z,B,U,$,H=[],V=0;V<256;++V)H[V]=(V+256).toString(16).substr(1)
function q(){var e,t,r,i=(e=new Uint8Array(16),L.getRandomValues(e))
return i[6]=15&i[6]|64,i[8]=63&i[8]|128,[(r=H)[(t=i)[0]],r[t[1]],r[t[2]],r[t[3]],"-",r[t[4]],r[t[5]],"-",r[t[6]],r[t[7]],"-",r[t[8]],r[t[9]],"-",r[t[10]],r[t[11]],r[t[12]],r[t[13]],r[t[14]],r[t[15]]].join("")}function W(e,t){if(I(e.lid))return e.lid
var{type:r,id:i}=e
return I(C(i))?`@ember-data:lid-${x(r)}-${i}`:q()}var G=new WeakMap
...
var r=C(e.lid),i=null!==r?this._cache.lids[r]:void 0
if(void 0!==i)return i
var n=x(e.type),a=C(e.id)
if(!1!==t||n&&a){var s=J(this._cache.types,n)
...
null===r&&(i=s.lid[o]),!0===t&&(void 0===i&&(i=X(a,n,o),this._cache.lids[i.lid]=i,s.lid[i.lid]=i,s._allIdentifiers.push(i)),null!==i.id&&(s.id[i.id]=i))}return i}}peekRecordIdentifier(e){return this._getRecordIdentifier(e,!1)}getOrCreateRecordIdentifier(e){return this._getRecordIdentifier(e,!0)}createIdentifierForNewRecord(e){var t=this._generate(e,"record"),r=X(e.id||null,e.type,t),i=J(this._cache.types,e.type)
return this._cache.lids[r.lid]=r,i.lid[t]=r,i._allIdentifiers.push(r),r}updateRecordIdentifier(e,t){var r=this.getOrCreateRecordIdentifier(e),i=C(t.id),n=function(e,t,r,i,n){var{id:a,type:s,lid:o}=t
if(null!==a&&a!==i&&null!==i){var l=J(e,t.type).id[i]
return void 0!==l&&l}var u=r.type&&x(r.type)
if(null!==a&&a===i&&u===s&&r.lid&&r.lid!==o){var c=n[r.lid]
return void 0!==c&&c}if(null!==a&&a===i&&u&&u!==s&&r.lid&&r.lid===o){var d=J(e,u).id[a]
return void 0!==d&&d}return!1}(this._cache.types,r,t,i,this._cache.lids)
if(!n&&t.type&&r.type!==x(t.type)){var s=a.assign({},t)
delete s.lid,n=this.getOrCreateRecordIdentifier(s)}if(n){var o=J(this._cache.types,r.type)
r=this._mergeRecordIdentifiers(o,r,n,t,i)}var l=r.id
if(function(e,t,r){var{id:i,lid:n}=t
t.type&&x(t.type),r(e,t,"record"),void 0!==i&&(e.id=C(i))}(r,t,this._update),l!==(i=r.id)&&null!==i){var u=J(this._cache.types,r.type)
u.id[i]=r,null!==l&&delete u.id[l]}return r}_mergeRecordIdentifiers(e,t,r,i,n){var a=this._merge(t,r,i),s=a===t?r:t
return this.forgetRecordIdentifier(s),e.id[n]=a,J(this._cache.types,r.type).id[n]=a,i.lid=a.lid,a}forgetRecordIdentifier(e){var t=this.getOrCreateRecordIdentifier(e),r=J(this._cache.types,t.type)
null!==t.id&&delete r.id[t.id],delete this._cache.lids[t.lid],delete r.lid[t.lid]
var i=r._allIdentifiers.indexOf(t)
r._allIdentifiers.splice(i,1),function(e){F.delete(e)}(e),this._forget(t,"record")}destroy(){this._reset()}}function J(e,t){var r=e[t]
return void 0===r&&(r={lid:Object.create(null),id:Object.create(null),_allIdentifiers:[]},e[t]=r),r}function X(e,t,r,i,n){var a,s={lid:r,id:e,type:t}
return a=s,F.set(a,"is-identifier"),s}function Z(e,t,r){var i=C(t)
if(!I(i)){if(I(r))return{type:e,id:i,lid:r}
throw new Error("Expected either id or lid to be a valid string")}return I(r)?{type:e,id:i,lid:r}:{type:e,id:i}}var ee=A.default.extend(S.default,{meta:v.reads("content.meta")}),te=M.default.extend(S.default)
function re(e,t){return te.create({promise:p.Promise.resolve(e,t)})}function ie(e,t){return ee.create({promise:p.Promise.resolve(e,t)})}function ne(e,t){return re(e.then((e=>e.getRecord())),t)}var ae,se=new E.default._Backburner(["coalesce","sync","notify"]),oe=/^\/?data\/(attributes|relationships)\/(.*)/,le=/^\/?data/,ue="base"
function ce(e){var t=[]
...
r===ue&&(a="Invalid Document",s="/data"),t.push({title:a,detail:i[n],source:{pointer:s}})}})),t}function de(e){var t={}
...
var a={state:ae.pending,request:t,type:n}
N(a,he,[r.recordIdentifier]),N(a,pe,e),this._pending[i].push(a),this._triggerSubscriptions(a),e.then((e=>{this._dequeue(i,a)
var r={state:ae.fulfilled,request:t,type:n,response:{data:e}}
N(r,he,a[he]),this._addDone(r),this._triggerSubscriptions(r)}),(e=>{this._dequeue(i,a)
var r={state:ae.rejected,request:t,type:n,response:{data:e&&e.error}}
...
this.modelName=t.type,this.identifier=t,i.hasRecord&&this._attributes,this.id=t.id,this.adapterOptions=e.adapterOptions,this.include=e.include,this.modelName=i.modelName,i.hasRecord&&(this._changedAttributes=ve(i).changedAttributes())}get record(){return this._internalModel.getRecord()}get _attributes(){if(null!==this.__attributes)return this.__attributes
...
return function(){return e.apply(void 0,r)}}function ye(e,t){var r=e.finally((()=>{t()||(r._subscribers.length=0)}))
return r}function _e(e){return!(n.get(e,"isDestroyed")||n.get(e,"isDestroying"))}function Re(e,t,r){return ye(p.resolve(e,r).then((t=>e)),(()=>_e(t)))}function we(e,t,r,i,n,a){return e.normalizeResponse(t,r,i,n,a)}var Oe=D("SaveOp")
...
var r="DS: Model#save "+this,i=P.default.defer(r),n={data:[{op:"saveRecord",recordIdentifier:e,options:t}]},a={snapshot:new ge(t,e,this._store),resolver:i,identifier:e,options:t,queryRequest:n}
return this._pendingSave.push(a),l._backburner.scheduleOnce("actions",this,this._flushPendingSaves),this.requestCache.enqueue(i.promise,a.queryRequest),i.promise}_flushPendingSave(e){var{snapshot:t,resolver:r,identifier:i,options:n}=e,a=this._store.adapterFor(i.type),s=n[Oe],o=t._internalModel,l=t.modelName,u=this._store,c=u.modelFor(l),d=p.Promise.resolve().then((()=>a[s](u,c,t))),h=u.serializerFor(l),f=`DS: Extract and notify about ${s} completion of ${o}`
d=(d=ye(d=Re(d,u,f),be(_e,o))).then((e=>{if(e)return we(h,u,c,e,t.id,s)}),(function(e){if(e&&!0===e.isAdapterError&&"InvalidError"===e.code){e.errors
...
if(a)return a.resolver.promise}var s=e.id,o=e.type,u=P.default.defer(`Fetching ${o}' with id: ${s}`),c={identifier:e,resolver:u,options:t,queryRequest:i},d=u.promise
0===this._pendingFetch.size&&l._backburner.schedule("actions",this,this.flushAllPendingFetches)
var h=this._pendingFetch
return h.has(o)||h.set(o,[]),h.get(o).push(c),this.requestCache.enqueue(d,c.queryRequest),d}_fetchRecord(e){var t=e.identifier,r=t.type,i=this._store.adapterFor(r),n=new ge(e.options,t,this._store),a=this._store.modelFor(t.type),s=p.Promise.resolve().then((()=>i.findRecord(this._store,a,t.id,n))),o=t.id,l=`DS: Handle Adapter#findRecord of '${r}' with id: '${o}'`
s=(s=Re(s,this._store,l)).then((e=>we(this._store.serializerFor(r),this._store,a,e,o,"findRecord")),(e=>{throw e}),`DS: Extract payload of '${r}'`),e.resolver.resolve(s)}handleFoundRecords(e,t,r){for(var i=Object.create(null),n=t.data,a=t.included||[],s=0,o=n.length;s<o;s++){var l=n[s],u=e[l.id]
i[l.id]=l
var c=a.concat(n)
...
return(u=Re(u,t,c)).then((e=>we(t.serializerFor(r),t,s,e,null,"findMany")),null,`DS: Extract payload of ${r}`)}_processCoalescedGroup(e,t,r,i,n){for(var a=t.length,s=new Array(a),o=new Array(a),l=0;l<a;l++)o[l]=t[l],s[l]=o[l].id
var u=this._store
...
h[p]=new ge(f,a[p],this._store)}for(var m=0,v=(d=r.groupRecordsForFindMany?r.groupRecordsForFindMany(this,h):[h]).length;m<v;m++)this._processCoalescedGroup(s,d[m],r,o,t)}else for(var g=0;g<n;g++)this._fetchRecord(e[g])}getPendingFetch(e){var t=this.requestCache.getPendingRequestsForRecord(e).filter((e=>"query"===e.type))
if(t.length>0)return t[0][pe]}flushAllPendingFetches(){this.isDestroyed||(this._pendingFetch.forEach(this._flushPendingFetchForType,this),this._pendingFetch.clear())}destroy(){this.isDestroyed=!0}}var Te=k.default
...
this._models=[]
for(var t=0;t<e.length;t++){e[t].unloadRecord()}}}class Se{constructor(){this._map=Object.create(null)}retrieve(e){var t=this._map[e]
return void 0===t&&(t=this._map[e]=new Ae(e)),t}clear(){for(var e=this._map,t=Object.keys(e),r=0;r<t.length;r++){e[t[r]].clear()}}}var Me=new WeakMap,ke=new WeakMap
function Ce(e){return ke.get(e)}function je(e){return ke.get(e)}function xe(e,t){ke.set(e,t)}function De(e){var t=Me.get(e)
return void 0===t&&(t=new Ne(e),Me.set(e,t)),t}class Ne{constructor(e){this._identityMap=void 0,this._newlyCreated=void 0,this.identifierCache=void 0,this.store=e,this.identifierCache=Y(e),this.identifierCache.__configureMerge(((e,t,r)=>{var i=e
...
return o&&a.remove(o,n.lid),null===s&&null===o||(null===s&&null!==o||s&&!s.hasRecord&&o&&o.hasRecord)&&(s&&a.remove(s,i.lid),(s=o)._id=i.id,a.add(s,i.lid)),i})),this._identityMap=new Se}lookup(e,t){void 0!==t&&this.identifierCache.getOrCreateRecordIdentifier(t)
var r=this.identifierCache.getOrCreateRecordIdentifier(e),i=this.peek(r)
return i?(i.hasScheduledDestroy()&&i.cancelDestroy(),i):this._build(r,!1)}peek(e){return this.modelMapFor(e.type).get(e.lid)}getByResource(e){var t=Z(e.type,e.id,e.lid)
...
t&&t.delete(this)}))},_pushIdentifiers(e){n.get(this,"content").pushObjects(e)},_removeIdentifiers(e){n.get(this,"content").removeObjects(e)},_takeSnapshot(){return n.get(this,"content").map((e=>De(this.store).lookup(e).createSnapshot()))}}),Fe=Ie.extend({init(){this.set("content",this.get("content")||o.A()),this._super(...arguments),this.query=this.query||null,this.links=this.links||null},replace(){throw new Error(`The result of a server query (on ${this.modelName}) is immutable.`)},_update(){var e=n.get(this,"store"),t=n.get(this,"query")
...
class $e{constructor(e){this.store=e.store,this.isDestroying=!1,this.isDestroyed=!1,this._liveRecordArrays=Object.create(null),this._pendingIdentifiers=Object.create(null),this._adapterPopulatedRecordArrays=[]}getRecordArraysForIdentifier(e){return ze(e)}_flushPendingIdentifiersForModelName(e,t){if(!this.isDestroying&&!this.isDestroyed){for(var r=[],i=0;i<t.length;i++){var n=t[i]
Be.delete(n),Ue(this.store,n)||r.push(n)}var a=this._liveRecordArrays[e]
a&&Ve(this.store,a,t),r.length>0&&Ge(this.store,r)}}_flush(){var e=this._pendingIdentifiers
for(var t in this._pendingIdentifiers=Object.create(null),e)this._flushPendingIdentifiersForModelName(t,e[t])}_syncLiveRecordArray(e,t){var r=this._pendingIdentifiers[t],i=Array.isArray(r),a=!i||0===r.length,s=De(this.store).modelMapFor(t),o=n.get(s,"length")===n.get(e,"length")
...
return-1!==r&&(e.splice(r,1),!0)},Ve=function(e,t,r){for(var i=[],n=[],a=0;a<r.length;a++){var s=r[a],o=Ue(e,s),l=ze(s)
o&&(l.has(t)||(i.push(s),l.add(t))),o||(n.push(s),l.delete(t))}i.length>0&&qe(t,i,De(e)),n.length>0&&We(t,n,De(e))},qe=function(e,t,r){e._pushIdentifiers(t)},We=function(e,t,r){e._removeIdentifiers(t)},Ge=function(e,t){for(var r=0;r<t.length;r++)Ye(e,t[r])},Ye=function(e,t){var r=ze(t=t)
De(e),r.forEach((function(e){We(e,[t])})),r.clear()}
function Qe(e){return e&&e.links&&e.links.related}var Ke=new WeakMap
function Je(e){return De(e.store).peek(Ke.get(e))}class Xe{constructor(e,t){this.store=e,Ke.set(this,t)}get recordData(){return this.store.recordDataFor(Ke.get(this),!1)}_resource(){}remoteType(){return Qe(this._resource())?"link":"id"}link(){var e,t=this._resource()
...
return t&&t.meta&&"object"==typeof t.meta&&(e=t.meta),e}}Object.defineProperty(Xe.prototype,"internalModel",{get(){return Ke.get(this)}})
class Ze extends Xe{constructor(e,t,r,i){super(e,t),this.key=i,this.belongsToRelationship=r,this.type=r.definition.type,this.parent=De(e).peek(t).recordReference,this.parentIdentifier=t}id(){var e=null,t=this._resource()
...
return this.store._backburner.join((()=>{r.push({op:"replaceRelatedRecord",record:i,field:this.key,value:je(t)})})),t}))}value(){var e=this._resource()
if(e&&e.data){var t=this.store._internalModelForResource(e.data)
if(t&&t.currentState.isLoaded)return t.getRecord()}return null}load(e){return De(this.store).peek(this.parentIdentifier).getBelongsTo(this.key,e)}reload(e){return De(this.store).peek(this.parentIdentifier).reloadBelongsTo(this.key,e).then((e=>this.value()))}}class et extends Xe{constructor(e,t,r,i){super(e,t),this.key=i,this.hasManyRelationship=r,this.type=r.definition.type,this.parent=De(e).peek(t).recordReference}_resource(){return this.recordData.getHasMany(this.key)}remoteType(){var e=this._resource()
...
var r=Je(this),i=t.map((e=>je(this.store.push(e)))),{graph:n,identifier:a}=this.hasManyRelationship
return this.store._backburner.join((()=>{n.push({op:"replaceRelatedRecords",record:a,field:this.key,value:i})})),r.getHasMany(this.key)}))}_isLoaded(){return!!this.hasManyRelationship.state.hasReceivedData&&this.hasManyRelationship.currentState.every((e=>!0===this.store._internalModelForResource(e).currentState.isLoaded))}value(){var e=Je(this)
return this._isLoaded()?e.getManyArray(this.key):null}load(e){return Je(this).getHasMany(this.key,e)}reload(e){return Je(this).reloadHasMany(this.key,e)}}class tt extends Xe{get type(){return this.identifier().type}get _id(){var e=this.identifier()
return e?e.id:null}id(){return this._id}identifier(){return Ke.get(this)}remoteType(){return"identity"}push(e){return p.resolve(e).then((e=>this.store.push(e)))}value(){if(null!==this._id){var e=Je(this)
...
return e}function st(e){return at(nt(it),e)}var ot=st({dirtyType:"created",isNew:!0,setup(e){e.store.recordArrayManager.recordDidChange(e.identifier)}})
...
return n=this.store._findHasManyByJsonApiResource(a,this,t,i).then((()=>Et(this,e,t,r,null)),(i=>Et(this,e,t,r,i))),this._relationshipPromisesCache[e]=n,n}getHasMany(e,t){var r=(0,require("@ember-data/record-data/-private").graphFor)(this.store).get(this.identifier,e),{definition:i,state:n}=r,a=this.getManyArray(e,i)
...
if("hasMany"===e)return i?i._update(r.promise,r.content):i=this._relationshipProxyCache[t]=new ft(r.promise,r.content),i
...
this.hasRecord&&this._record._notifyProperties(t),this.send("pushedData")}setDirtyHasMany(e,t){return this._recordData.setDirtyHasMany(e,Tt(t))}setDirtyBelongsTo(e,t){return this._recordData.setDirtyBelongsTo(e,Pt(t))}setDirtyAttribute(e,t){if(this.isDeleted())throw new w.default(`Attempted to set '${e}' on the deleted record ${this}`)
...
n.get(this,"isError")&&this.didCleanError(),this.send("rolledBack"),this._record&&e&&e.length>0&&this._record._notifyProperties(e)}))}transitionTo(e){var t,r,i,n,a=function(e){return _t[e]||(_t[e]=wt(e)[0])}(e),s=this.currentState,o=`${s.stateName}->${e}`
...
yt[o]={setups:t,enters:r,state:s}}for(i=0,n=r.length;i<n;i++)r[i].enter(this)
...
"belongsTo"===n?r=new Ze(this.store,a,i,t):"hasMany"===n&&(r=new et(this.store,a,i,t)),this.references[t]=r}return r}}function Et(e,t,r,i,n){delete e._relationshipPromisesCache[t],r.state.shouldForceReload=!1
var a="hasMany"===r.definition.kind
if(a&&i.notify(),n){r.state.hasFailedLoadAttempt=!0
var s=e._relationshipProxyCache[t]
throw s&&!a&&s.content&&s.content.isDestroying&&s.set("content",null),n}return a&&i.set("isLoaded",!0),r.state.hasFailedLoadAttempt=!1,r.state.isStale=!1,i}function Tt(e){return e.map(Pt)}function Pt(e){if(!e)return null
if(e.then){var t=e.get&&e.get("content")
return t?ve(t):null}return ve(e)}var At=new WeakMap
function St(e,t){var r=At.get(e)
void 0===r&&(r=Object.create(null),At.set(e,r))
var i=r[t]
return void 0===i&&(i=r[t]=new kt(e,t)),i}function Mt(e){var t=new Map
for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.set(r,e[r])
return t}class kt{constructor(e,t){this.__store=e,this.modelName=t}get fields(){var e=this.__store._attributesDefinitionFor(this.modelName),t=this.__store._relationshipsDefinitionFor(this.modelName),r=new Map
return Object.keys(e).forEach((e=>r.set(e,"attribute"))),Object.keys(t).forEach((e=>r.set(e,t[e].kind))),r}get attributes(){return Mt(this.__store._attributesDefinitionFor(this.modelName))}get relationshipsByName(){return Mt(this.__store._relationshipsDefinitionFor(this.modelName))}eachAttribute(e,t){var r=this.__store._attributesDefinitionFor(this.modelName)
...
Object.keys(r).forEach((i=>{r[i].type&&e.call(t,i,r[i])}))}}var Ct,jt,xt,Dt=new WeakMap,Nt=new WeakMap
class It{constructor(e){this.store=e}subscribe(e,t){var r=Y(this.store).getOrCreateRecordIdentifier(e)
Dt.set(r,t)
var i={}
return Nt.set(i,r),i}notify(e,t,r){var i=Y(this.store).getOrCreateRecordIdentifier(e),n=Dt.get(i)
return!!n&&(n(i,t,r),!0)}}function Ft(e,t,r,i,n,a){var s=n.map((e=>e.createSnapshot(a.get(e)))),o=t.modelFor(r),l=e.findMany(t,o,i,s),u=`DS: Handle Adapter#findMany of '${r}'`
if(void 0===l)throw new Error("adapter.findMany returned undefined, this was very likely a mistake")
return(l=Re(l,t,u)).then((e=>{var i=we(t.serializerFor(r),t,o,e,null,"findMany")
return t._push(i)}),null,`DS: Extract payload of ${r}`)}function Lt(e,t,r,i){var n,s,o=t.data?(n=t.data,s=(t,n)=>{var{id:s,type:o}=t
...
return Array.isArray(t.included)||(t.included=[]),t.included.push(u),t}function zt(e,t,r,i){var n=t.modelFor(r),a=t.peekAll(r),s=a._createSnapshot(i),o=p.Promise.resolve().then((()=>e.findAll(t,n,null,s)))
return(o=Re(o,t,"DS: Handle Adapter#findAll of "+n)).then((e=>{var i=we(t.serializerFor(r),t,n,e,null,"findAll")
return t._push(i),t._didUpdateAll(r),a}),null,"DS: Extract payload of findAll ${modelName}")}function Bt(e){return"function"==typeof e._inverseKey}Ct=e=>(jt=jt||require("@ember-data/record-data/-private").peekGraph)(e)
class Ut{constructor(e){this._store=e,this._willNotify=!1,this._pendingNotifies=new Map}get identifierCache(){return Y(this._store)}_scheduleNotification(e,t,r){var i=this._pendingNotifies.get(e);(i||(i=new Map,this._pendingNotifies.set(e,i)),i.set(t,r),!0!==this._willNotify)&&(this._willNotify=!0,this._store._backburner.schedule("notify",this,this._flushNotifications))}notifyErrorsChange(e,t,r){var i=Z(e,t,r),n=Y(this._store).getOrCreateRecordIdentifier(i),a=De(this._store).peek(n)
...
return i?void 0!==i.inverse?i.inverse:Bt(i)?i._inverseKey(this._store,r):null:null}inverseIsAsyncForRelationship(e,t){var r=this._store.modelFor(e),i=this.relationshipsDefinitionFor(e)[t]
return!!i&&(null!==i.inverse&&(void 0!==i.inverseIsAsync?!!i.inverseIsAsync:!!Bt(i)&&i._inverseIsAsync(this._store,r)))}notifyPropertyChange(e,t,r,i){var n=Z(e,t,r),a=Y(this._store).getOrCreateRecordIdentifier(n),s=De(this._store).peek(a)
s&&s.notifyPropertyChange(i)}notifyHasManyChange(e,t,r,i){var n=Z(e,t,r),a=Y(this._store).getOrCreateRecordIdentifier(n)
this._scheduleNotification(a,i,"hasMany")}notifyBelongsToChange(e,t,r,i){var n=Z(e,t,r),a=Y(this._store).getOrCreateRecordIdentifier(n)
this._scheduleNotification(a,i,"belongsTo")}notifyStateChange(e,t,r,i){var n=Z(e,t,r),a=Y(this._store).getOrCreateRecordIdentifier(n),s=De(this._store).peek(a)
s&&s.notifyStateChange(i)}recordDataFor(e,t,r){var i,n=!1
if(t||r){var a=Z(e,t,r)
i=Y(this._store).getOrCreateRecordIdentifier(a)}else n=!0,i={type:e}
return this._store.recordDataFor(i,n)}setRecordId(e,t,r){this._store.setRecordId(e,t,r)}isRecordInUse(e,t,r){var i=Z(e,t,r),n=Y(this._store).getOrCreateRecordIdentifier(i),a=De(this._store).peek(n)
if(!a)return!1
var s=a._record
return s&&!(s.isDestroyed||s.isDestroying)}disconnectRecord(e,t,r){var i=Z(e,t,r),n=Y(this._store).getOrCreateRecordIdentifier(i),a=Ct(this)
a&&a.remove(n)
var s=De(this._store).peek(n)
s&&s.destroyFromRecordData()}}var $t,Ht,Vt=new WeakMap
class qt extends O.default{constructor(){super(...arguments),this._backburner=se,this.recordArrayManager=new $e({store:this}),this._notificationManager=void 0,this._adapterCache=Object.create(null),this._serializerCache=Object.create(null),this._storeWrapper=new Ut(this),this._pendingSave=[],this._updatedInternalModels=[],this._pendingFetch=new Map,this._fetchManager=void 0,this._schemaDefinitionService=void 0,this._trackedAsyncRequests=void 0,this.shouldAssertMethodCallsOnDestroyedStore=!1,this.shouldTrackAsyncRequests=!1,this.generateStackTracesForTrackedRequests=!1,this._trackAsyncRequestStart=void 0,this._trackAsyncRequestEnd=void 0,this.__asyncWaiter=void 0,this._fetchManager=new Ee(this),this._notificationManager=new It(this),this.__recordDataFor=this.__recordDataFor.bind(this)}getRequestStateService(){return this._fetchManager.requestCache}get identifierCache(){return Y(this)}_instantiateRecord(e,t,r,i,n){if(void 0!==n){"id"in n&&e.setId(n.id)
var a=this._relationshipsDefinitionFor(t)
if(null!==a)for(var s,o=Object.keys(n),l=0;l<o.length;l++){var u=o[l],c=a[u]
void 0!==c&&(s="hasMany"===c.kind?Tt(n[u]):Pt(n[u]),n[u]=s)}}var d=r._initRecordCreateOptions(n),h=this.instantiateRecord(i,d,this.__recordDataFor,this._notificationManager)
return xe(h,i),h}_internalDeleteRecord(e){e.deleteRecord()}_attributesDefinitionFor(e,t){return t?this.getSchemaDefinitionService().attributesDefinitionFor(t):this.getSchemaDefinitionService().attributesDefinitionFor(e)}_relationshipsDefinitionFor(e,t){return t?this.getSchemaDefinitionService().relationshipsDefinitionFor(t):this.getSchemaDefinitionService().relationshipsDefinitionFor(e)}registerSchemaDefinitionService(e){this._schemaDefinitionService=e}getSchemaDefinitionService(){return this._schemaDefinitionService}_relationshipMetaFor(e,t,r){return this._relationshipsDefinitionFor(e)[r]}modelFor(e){return St(this,e)}_hasModelFor(e){return this.getSchemaDefinitionService().doesTypeExist(e)}createRecord(e,t){return l._backburner.join((()=>this._backburner.join((()=>{var r=x(e),i=a.assign({},t)
s.isNone(i.id)&&(i.id=this._generateId(r,i)),i.id=C(i.id)
var n=De(this).build({type:r,id:i.id})
return n.send("loadedData"),n.didCreateRecord(),n.getRecord(i)}))))}_generateId(e,t){var r=this.adapterFor(e)
return r&&r.generateIdForRecord?r.generateIdForRecord(this,e,t):null}deleteRecord(e){this._backburner.join((()=>{var t=Ce(e)
if(t){var r=De(this).peek(t)
r&&r.deleteRecord()}else e.deleteRecord()}))}unloadRecord(e){var t=Ce(e)
if(t){var r=De(this).peek(t)
r&&r.unloadRecord()}else e.unloadRecord()}find(e,t,r){return this.findRecord(e,t)}findRecord(e,t,r){var i=x(e),n=j(t),a=Z(i,n),s=De(this).lookup(a)
return r=r||{},this.hasRecordForId(i,n)?ne(this._findRecord(s,r),`DS: Store#findRecord ${i} with id: ${t}`):this._findByInternalModel(s,r)}_findRecord(e,t){if(t.reload)return this._scheduleFetch(e,t)
...
return r?r.then((()=>p.Promise.resolve(e))):this._scheduleFetch(e,t)}return p.Promise.resolve(e)}findByIds(e,t){for(var r=new Array(t.length),i=x(e),n=0;n<t.length;n++)r[n]=this.findRecord(i,t[n])
return ie(p.all(r).then(o.A,null,`DS: Store#findByIds of ${i} complete`))}_fetchRecord(e,t){var r=e.modelName
...
return(l=Re(l,t,u)).then((e=>{var n=we(t.serializerFor(o),t,r,e,i,"findRecord")
...
E[T]=P,O[T]=P.id}if(w>1)(function(e){Ft(i,r,t,O,e,l).then((function(t){p(t,e)})).catch((function(t){f(e,t)}))})(E)
else if(1===O.length){h(o[E[0].id])}}}else for(var A=0;A<a;A++)h(e[A])}getReference(e,t){var r=Z(x(e),j(t)),i=Y(this).getOrCreateRecordIdentifier(r)
if(i){if(Vt.has(i))return Vt.get(i)
var n=new tt(this,i)
return Vt.set(i,n),n}}peekRecord(e,t){var r=x(e),i=j(t)
if(this.hasRecordForId(r,i)){var n=Z(r,i)
return De(this).lookup(n).getRecord()}return null}_reloadRecord(e,t){t.isReloading=!0
var{id:r,modelName:i}=e
return this.adapterFor(i),this._scheduleFetch(e,t)}hasRecordForId(e,t){var r={type:x(e),id:j(t)},i=Y(this).peekRecordIdentifier(r),n=i&&De(this).peek(i)
return!!n&&n.currentState.isLoaded}recordForId(e,t){var r=Z(e,j(t))
return De(this).lookup(r).getRecord()}findMany(e,t){for(var r=new Array(e.length),i=0;i<e.length;i++)r[i]=this._findEmptyInternalModel(e[i],t)
...
return(u=ye(u=Re(u,t,c),be(_e,r))).then((e=>{var i=we(t.serializerFor(n.type),t,o,e,null,"findHasMany")
return i=Lt(t,i,r,n),t._push(i)}),null,`DS: Extract payload of '${r.modelName}' : hasMany '${n.type}'`)}(this.adapterFor(e.modelName),this,e,t,r,i)}_findHasManyByJsonApiResource(e,t,r,i){if(!e)return p.resolve([])
var{definition:n,state:a}=r,s=this.adapterFor(n.type),{isStale:o,hasDematerializedInverse:l,hasReceivedData:u,isEmpty:c,shouldForceReload:d}=a,h=Wt(this,e)
...
return(u=ye(u=Re(u,t,c),be(_e,r))).then((e=>{var i=we(t.serializerFor(n.type),t,o,e,null,"findBelongsTo")
return i.data||i.links||i.meta?(i=Lt(t,i,r,n),t._push(i)):null}),null,`DS: Extract payload of ${r.modelName} : ${n.type}`)}(this.adapterFor(e.modelName),this,e,t,r,i)}_fetchBelongsToLinkFromResource(e,t,r,i){return e&&e.links&&e.links.related?this.findBelongsTo(t,e.links.related,r,i).then((e=>e?e.getRecord():null)):p.resolve(null)}_findBelongsToByJsonApiResource(e,t,r,i){if(!e)return p.resolve(null)
var n=e.data?this._internalModelForResource(e.data):null,{isStale:a,hasDematerializedInverse:s,hasReceivedData:o,isEmpty:l,shouldForceReload:u}=e._relationship.state,c=Wt(this,e),d=e.links&&e.links.related&&(u||s||a||!c&&!l)
...
var n=x(e)
return this._query(n,t,null,i)}_query(e,t,r,i){return ie(function(e,t,r,i,n,a){var s=t.modelFor(r)
n=n||t.recordArrayManager.createAdapterPopulatedRecordArray(r,i)
var o=p.Promise.resolve().then((()=>e.query(t,s,i,n,a)))
return(o=Re(o,t,`DS: Handle Adapter#query of ${r}`)).then((e=>{var a=we(t.serializerFor(r),t,s,e,null,"query"),o=t._push(a).map((e=>e.identifier))
return n?n._setIdentifiers(o,a):n=t.recordArrayManager.createAdapterPopulatedRecordArray(r,i,o,a),n}),null,`DS: Extract payload of query ${r}`)}(this.adapterFor(e),this,e,t,r,i))}queryRecord(e,t,r){var i=x(e),n=this.adapterFor(i),a={}
return r&&r.adapterOptions&&(a.adapterOptions=r.adapterOptions),re(function(e,t,r,i,n){var a=t.modelFor(r),s=p.Promise.resolve().then((()=>e.queryRecord(t,a,i,n)))
return(s=Re(s,t,`DS: Handle Adapter#queryRecord of ${r}`)).then((e=>{var i=we(t.serializerFor(r),t,a,e,null,"queryRecord")
return t._push(i)}),null,`DS: Extract payload of queryRecord ${r}`)}(n,this,i,t,a).then((e=>e?e.getRecord():null)))}findAll(e,t){var r=x(e)
return this._fetchAll(r,this.peekAll(r),t)}_fetchAll(e,t,r){void 0===r&&(r={})
var i=this.adapterFor(e)
if(r.reload)return n.set(t,"isUpdating",!0),ie(zt(i,this,e,r))
var a=t._createSnapshot(r)
return!1!==r.reload&&(i.shouldReloadAll&&i.shouldReloadAll(this,a)||!i.shouldReloadAll&&0===a.length)?(n.set(t,"isUpdating",!0),ie(zt(i,this,e,r))):(!1===r.backgroundReload||(r.backgroundReload||!i.shouldBackgroundReloadAll||i.shouldBackgroundReloadAll(this,a))&&(n.set(t,"isUpdating",!0),zt(i,this,e,r)),ie(p.Promise.resolve(t)))}_didUpdateAll(e){this.recordArrayManager._didUpdateAll(e)}peekAll(e){var t=x(e)
...
return i.isNew&&i.isNew()?n="createRecord":i.isDeleted&&i.isDeleted()&&(n="deleteRecord"),N(r,Oe,n),this._fetchManager.scheduleSave(e.identifier,r).then((t=>{this._backburner.join((()=>{var r=t&&t.data
...
t&&(i=t.data)
var n=Y(this),a=e.identifier
"deleteRecord"!==r&&i&&n.updateRecordIdentifier(a,i),e.adapterDidCommit(i)}recordWasInvalid(e,t,r){e.adapterDidInvalidate(t,r)}recordWasError(e,t){e.adapterDidError(t)}setRecordId(e,t,r){De(this).setRecordId(e,t,r)}_load(e){var t=Z(x(e.type),j(e.id),C(e.lid)),r=De(this).lookup(t,e),i="root.loading"===r.currentState.stateName,n=!1===r.currentState.isEmpty&&!i,a=r.identifier
if(n||i){var s=Y(this).updateRecordIdentifier(a,e)
s!==a&&(a=s,r=De(this).lookup(a))}return r.setupData(e),n||this.recordArrayManager.recordDidChange(a),r}push(e){var t=this._push(e)
...
r.pushPayload(this,i)}reloadManyArray(e,t,r,i){return t.reloadHasMany(r,i)}reloadBelongsTo(e,t,r,i){return t.reloadBelongsTo(r,i)}_internalModelForResource(e){return De(this).getByResource(e)}_internalModelForId(e,t,r){var i=Z(e,t,r)
return De(this).lookup(i)}serializeRecord(e,t){var r=je(e)
...
return function(e,t){me.set(e,t)}(e,t),xe(t,e),t}createRecordDataFor(e,t,r,i){void 0===xt&&(xt=T.default("@ember-data/record-data/-private").RecordData)
var n=Y(this).getOrCreateRecordIdentifier({type:e,id:t,lid:r})
return new xt(n,i)}__recordDataFor(e){var t=Y(this).getOrCreateRecordIdentifier(e)
return this.recordDataFor(t,!1)}recordDataFor(e,t){var r
return!0===t?((r=De(this).build({type:e.type,id:null})).send("loadedData"),r.didCreateRecord()):r=De(this).lookup(e),r._recordData}normalize(e,t){var r=x(e),i=this.serializerFor(r),n=this.modelFor(r)
return i.normalize(n,t)}newClientId(){}_internalModelsFor(e){return De(this).modelMapFor(e)}adapterFor(e){var r=x(e),{_adapterCache:i}=this,a=i[r]
if(a)return a
...
return void 0!==(a=o?i[o]||s.lookup(`adapter:${o}`):void 0)?(n.set(a,"store",this),i[r]=a,i[o]=a,a):(a=i["-json-api"]||s.lookup("adapter:-json-api"),n.set(a,"store",this),i[r]=a,i["-json-api"]=a,a)}serializerFor(e){var r=x(e),{_serializerCache:i}=this,a=i[r]
if(a)return a
...
return n&&n.destroy(),super.destroy()}willDestroy(){super.willDestroy(),this.recordArrayManager.destroy(),Y(this).destroy()
...
return Array.isArray(t.data)?!t.data.reduce(((t,i)=>t||Gt(e,r,i).currentState.isEmpty),!1):!t.data||!Gt(e,r,t.data).currentState.isEmpty}function Gt(e,t,r){var i=t.getOrCreateRecordIdentifier(r)
return e._internalModelForResource(i)}n.defineProperty(qt.prototype,"defaultAdapter",n.computed("adapter",(function(){var e=this.adapter||"-json-api"
...
r=n.get(i,"relationshipsObject")||null,this._relationshipsDefCache[t]=r}return r}doesTypeExist(e){var t=x(e)
return null!==Qt(this.store,this._modelFactoryCache,t)}}function Qt(e,r,i){var n=r[i]
if(!n){if(n=function(e,r){return t.getOwner(e).factoryFor(`model:${r}`)}(e,i),n||(n=$t(e,i)),!n)return null
var a=n.class
if(a.isModel)a.modelName&&Object.prototype.hasOwnProperty.call(a,"modelName")||Object.defineProperty(a,"modelName",{value:i})
r[i]=n}return n}e.AdapterPopulatedRecordArray=Fe,e.DeprecatedEvented=Te,e.InternalModel=Ot,e.PromiseArray=ee,e.PromiseObject=te,e.RecordArray=Ie,e.RecordArrayManager=$e,e.RecordDataStoreWrapper=Ut,e.RootState=vt,e.Snapshot=ge,e.SnapshotRecordArray=Pe,e.Store=class extends qt{constructor(){super(...arguments),this._modelFactoryCache=Object.create(null),this._relationshipsDefCache=Object.create(null),this._attributesDefCache=Object.create(null)}instantiateRecord(e,r,i,n){var s=e.type,o={store:this,_internalModel:this._internalModelForResource(e),container:null}
